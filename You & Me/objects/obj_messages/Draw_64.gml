...
if _is_computer {
	...
	_conta_scr = 100;
	_conta_max = 0;
	_conta_min = -((array_length(_conta_count))*(_conta_hei+_conta_y_buff)-room_height+(2*_panel_y));
	...
	_conta_min = -((array_length(_conta_count))*(_conta_hei+_conta_y_buff)-room_height+(2*_panel_y));
		...
		print(_conta_min, " ", _conta_max, " ", contact_message_y);
		
		print("Is ", contact_message_y, " greater than ", _conta_min, " and less than ", _conta_max, "?");
